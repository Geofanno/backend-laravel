...
<head>
    ...
    <title>Dashboard &mdash; BANK BTN KCP AIRLANGGA</title>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('admin.dashboard.index') }}">BANK BTN KCP AIRLANGGA</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="{{ route('admin.dashboard.index') }}">BTN</a>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2022 <div class="bullet"></div> GEOFANNO MAYCELLINO <div class="bullet"></div> All Rights
                    Reserved.
                </div>
